...
MVP Десктопное приложение для автоматизации учёта товаров в магазине техники Apple. Позволяет управлять товарами, поставщиками, покупателями, закупками и продажами, а также формировать отчёты и экспортировать их в Excel.
